  ...
  <div style="max-width:600px;margin:0 auto;padding:24px 16px;">
    ...
    <div style="background:#ffffff;border:1px solid #e5e7eb;border-top:none;padding:32px 24px;">
      ...
      <div style="border-top:1px solid #e5e7eb;padding-top:20px;">
        <p style="color:#6b7280;font-size:13px;margin:0;">
          Need help? Email us at <a href="mailto:info@prlsitesolutions.co.uk" style="color:#1F4E79;">info@prlsitesolutions.co.uk</a> — we're happy to assist.
        </p>
      </div>
    </div>
    ...
    <div style="padding:16px 24px;text-align:center;">
      <p style="color:#9ca3af;font-size:11px;margin:0;">
        PRL Site Solutions | Recruitment Specialists | <a href="https://prismworkforce.online" style="color:#9ca3af;">prismworkforce.online</a>
      </p>
    </div>
...
export async function POST() {
  try {
    ...
    // Get all contractors not yet invited, with a real email
    ...
    for (const contractor of contractors) {
      try {
        ...
        const { error } = await resend.emails.send({
          from: FROM,
          to: [email],
          subject: "Welcome to the PRL Site Solutions Contractor Portal",
          html,
        });
        ...
        await prisma.activityLog.create({
          data: {
            ...
            details: `Campaign launch email sent to ${email}`,
          },
        });
